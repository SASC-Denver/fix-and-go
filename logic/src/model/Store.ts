 ...
 */
import { GameObjectType, IGameObject } from "./game";
import { GameObject, IGameObjectAttributes } from "./GameObject";
import { Inventory } from "./Inventory";

export interface IStoreAttributes extends IGameObjectAttributes {}

/**
 * Store containing items that a player can buy or sell.
 */
export class Store extends GameObject {
  inventory: Inventory;

  constructor(attributes: IStoreAttributes) {
   ...
   * @return
   */
  buyItem(id: number, money: number): IGameObject {
